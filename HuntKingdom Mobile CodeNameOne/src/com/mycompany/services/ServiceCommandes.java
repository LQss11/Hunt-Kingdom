...
public class ServiceCommandes {
    ...
    public static ArrayList<back> back;
   ...
   public ArrayList<Commandes> parseCommandes(String jsonText) {
        ...
        try {
            ...
            for (Map<String, Object> obj : list) {
               ...
               b.setPrixTOT(((int) Float.parseFloat(cmd.get("prixTTC").toString())));
                ...
                for (Map.Entry<String, Object> entry : pr.entrySet()) {
                    ...
                    b.setNomProd(prod.get("reference").toString());

                   b.setPrixTTC(((int) Float.parseFloat(prod.get("prixTTC").toString())));

                    b.setQuantity(((int) Float.parseFloat(prod.get("quantite").toString())));
