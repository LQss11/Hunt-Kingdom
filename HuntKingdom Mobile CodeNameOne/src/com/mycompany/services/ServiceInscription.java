...
public class ServiceInscription {
    ...
    public boolean AInscrire(int ev) {
        String url = Statics.BASE_URL + "/evenement/jsoninscritdelete/" + ev + "/" + SignInForm.US.getId();
        req.setUrl(url);
        System.out.println("url == " + url + "request is = ");
        req.setPost(true);
        req.setHttpMethod("DELETE");
    ...
    public boolean Inscrire(int ev, int r) {

        String url = Statics.BASE_URL + "/evenement/jsoninscritadd/" + ev + "/" + SignInForm.US.getId() + "/" + r;
        req.setUrl(url);
        req.setPost(true);
    ...
    public void rate(int progress, int id) {
        String url = Statics.BASE_URL + "/evenement/jsonrate/" + progress + "/" + id;
        req.setUrl(url);
        req.setHttpMethod("POST");
