...
public class ReclamationController implements Initializable {
    ...
    private void AjouterReclamation(ActionEvent event) throws DocumentException, BadElementException, IOException {
        ...
        if ((textfieldTypeReclamation.getText().length() != 0) && (textfieldDescriptionReclamation.getText().length() != 0) && (textfieldSujetReclamation.getText().length() != 0)) {
            Reclamation r = new Reclamation(textfieldTypeReclamation.getText(), 0, textfieldSujetReclamation.getText(), textfieldDescriptionReclamation.getText(), date, "Pending", userId);
            ...
            try {
                ...
                try {
                    ...
                    //NodeName = "/FXML/ReclamationOwn.fxml";
