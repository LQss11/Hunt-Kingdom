...
public class Admin_DashboardController implements Initializable {
    ...
    @FXML
    private ImageView profilephoto1;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (ReclamationBackController.NodeName != null) {
            try {
                pnl_scroll.getChildren().add((Node) FXMLLoader.load(getClass().getResource(ReclamationBackController.NodeName)));
                ReclamationBackController.NodeName = null;
