...
public class User_HomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String str = Statics.PATH + s.findByID(userId).getIMAGE();
        ...
        //FXML/ReclamationOwn.fxml
        refreshNodes();
        
        if (ReclamationController.NodeName != null) {
            try {
                pnl_scroll.getChildren().add((Node) FXMLLoader.load(getClass().getResource(ReclamationController.NodeName)));
                ReclamationController.NodeName = null;
            } catch (IOException ex) {
                Logger.getLogger(User_HomeController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }

        if (ReclamationFrontShowOneController.NodeName != null) {
            try {
                pnl_scroll.getChildren().add((Node) FXMLLoader.load(getClass().getResource(ReclamationFrontShowOneController.NodeName)));
                ReclamationFrontShowOneController.NodeName = null;
            } catch (IOException ex) {
                Logger.getLogger(User_HomeController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        System.out.println("aaaaaaa = " + ReclamationOwnController.NodeName1);

        if (ReclamationOwnController.NodeName1 != null) {
            try {
                pnl_scroll.getChildren().add((Node) FXMLLoader.load(getClass().getResource(ReclamationOwnController.NodeName1)));
                ReclamationOwnController.NodeName1 = null;
            } catch (IOException ex) {
                Logger.getLogger(User_HomeController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void refreshNodes() {
        ...
        ReclamationFront.setOnAction(event -> {
            pnl_scroll.getChildren().clear();
            try {
                pnl_scroll.getChildren().add((Node) FXMLLoader.load(getClass().getResource("/FXML/Reclamation.fxml")));
    ...
    private void showInscriptions() throws SQLException {
        ...
        while (rs.next()) {
            ...
            try {
                ...
                //         Test image Show        //  
                File i = new File(Statics.PATH + rs.getString(10));
                System.out.println("image name osss = " + e1.getImage());
                    image.setImage(new Image(Statics.PATH + e1.getImage()));
