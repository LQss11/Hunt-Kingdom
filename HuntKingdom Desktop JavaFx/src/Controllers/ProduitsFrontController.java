...
tilePane2.setPrefColumns(nCols);
 ...
 String str=Statics.PATH +p.getImage();
  //String str="file:C://Users/LQss/Desktop/"+p.getImage();
  ...
  v.setFitHeight(170);
           ...
           ImageView ivv=new ImageView();
            String strr="file:"+System.getProperty("user.dir")+"/src/FXML/images/hr.png";
            //String strr="file:C://Users/LQss/Desktop/welcome.jpg";
...
Button btnpanier = new Button("ajouter", ivv);
     ...
     try {
         ...
         Logger.getLogger(ProduitsFrontController.class.getName()).log(Level.SEVERE, null, ex);
            ...
            btnpanier.setOnAction((ActionEvent event) -> {
                
            
             if (!hunt.Hunt.listeprod.contains(p)) {
            hunt.Hunt.listeprod.add(p);
        } else {
            
             Alert alert1 = new Alert(Alert.AlertType.WARNING);
            alert1.setTitle("Alert");
            alert1.setContentText("Produit est deja exist");
            alert1.showAndWait();
             ...
             pageBox.getChildren().add(btnpanier);
        return pageBox;
    } 
...
SearchProduitFront.setOnKeyReleased(e->{
   ...
   public void createWishElements(){
    ...
    private void OpenEvenements(ActionEvent event) {
         EvntBtn.getScene().getWindow().hide();
        try {
            Stage stage = new Stage();
            stage.setTitle("");
