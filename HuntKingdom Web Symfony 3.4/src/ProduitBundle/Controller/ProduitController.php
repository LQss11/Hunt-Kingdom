...
$html=$html." </tbody>
    ...
    <footer>
     Hunt Kingdom
        ...
        $snappy->generateFromHtml($html, 'D:\ListOfProducts\ListOfProducts'.$date->format("yy/M/d").'.pdf');
...
";
    ...
    <footer>
     Hunt Kingdom
        ...
        $snappy->generateFromHtml($html, 'C:\wamp64\www\Integration\HuntKingdom\web\uploads\ListOfProducts\ProductsList'.'.pdf');
