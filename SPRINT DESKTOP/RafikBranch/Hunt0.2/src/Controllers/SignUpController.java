...
public class SignUpController implements Initializable {
    ...
    private void Add(ActionEvent event) {
       ...
       Utilisateurs u = new Utilisateurs(FnId.getText(), Email, hashed, (Date) BiId, LnId.getText(), PhId.getText(), PhId.getText());
       ...
       if (u1 != null) {
         ...
         if (FnId.getText().isEmpty() || LnId.getText().isEmpty() || EmId.getText().isEmpty() || PswId.getText().isEmpty()) {
            lblrole.setTextFill(Color.TOMATO);
