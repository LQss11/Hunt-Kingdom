...
public class Evenement {
    ...
    public Evenement(int id, String nom, String type, double prix, int nbrplace, Date date, String place, String description, int duree, String image) {
        this.id = id;
        this.nom = nom;
        this.type = type;
        this.prix = prix;
    ...
    public Evenement(String nom, String type, double prix, int nbrplace,Date date,String place, String description, int duree, String image) {
        this.nom = nom;
        this.type = type;
        this.prix = prix;
        this.nbrplace = nbrplace;
