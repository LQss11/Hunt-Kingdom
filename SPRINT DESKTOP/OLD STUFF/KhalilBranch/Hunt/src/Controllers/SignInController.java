...
public class SignInController implements Initializable {
    ...
    private void LoginUser() {
        ...
        try {
            ...
            User_HomeController dashboard_UserController = loader.getController();
    ...
    private void LoginAdmin() {
        ...
        try {
            ...
            Parent root = loader.load();
            //Admin_DashboardController Admin_Dashboard = loader.getController();
            //Admin_Dashboard.transferMessage(txtemail.getText());
            Scene scene = new Scene(root);
            dashboardStage.setScene(scene);
            dashboardStage.show();
        } catch (IOException ex) {
