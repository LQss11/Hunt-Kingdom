...
public class Admin_DashboardController implements Initializable {
    ...
    @FXML
    private void OpenGestProduit(ActionEvent event) {
        
        buttonProduit.getScene().getWindow().hide();
        try {
           
            Stage dashboardStage = new Stage();
            dashboardStage.setTitle("");
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GestionsProduits.fxml"));
