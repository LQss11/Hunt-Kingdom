...
public class ServiceEvenement {
    ...
    public int nbrplaceUpdateAdd(Evenement r) throws SQLException {

        String requestUpdate = "UPDATE `evenement` SET `nbrplace`=?  WHERE `id`=?";
        PreparedStatement pre = con.prepareStatement(requestUpdate);
        pre.setInt(1, r.getNbrplace() + 1);
        pre.setInt(2, r.getId());
        System.out.println(r);
        return pre.executeUpdate();
    }

    public int nbrplaceUpdateDel(Evenement r) throws SQLException {
