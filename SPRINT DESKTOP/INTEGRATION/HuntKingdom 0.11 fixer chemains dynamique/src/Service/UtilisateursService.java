...
public class UtilisateursService {
    ...
    public void add(Utilisateurs u) {
        String req = "INSERT INTO `user`(`firstname`, `email`, `password`, `date`, `lastname`,`image`, `phone`,`enabled` ,`roles`,`username`,`email_canonical`,`username_canonical`,`last_login`) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            preparedStatement.setString(10, u.getUsername());
            preparedStatement.setString(11, u.getEmail_canonical());
            preparedStatement.setString(12, u.getUsername_canonical());
            preparedStatement.setDate  (13, u.getLast_login());
     ...
     public Utilisateurs findByID(int id) {
        ...
        try {
            ...
            while (resultSet.next()) {
                u = new Utilisateurs(resultSet.getString("USERNAME"),
    ...
    public List<Utilisateurs> getRole(int ENABLED) {
     ...
     public int updateLast(Utilisateurs r) throws SQLException {

        String requestUpdate = "UPDATE `user` SET `last_login`=? where `id`=?";
        PreparedStatement pre = connection.prepareStatement(requestUpdate);
        pre.setDate(1, r.getLast_login());
