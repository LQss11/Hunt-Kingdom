...
public class HuntKingdom {
    ...
    public static void main(String[] args) {
         ...
         */
 /* ----------------------------this is a test for showing reclamation object by user id---------------------------- */
 ...
 /*
         ...
         */
 /* ------------------------------------------------------      FEEDBACK CRUD     ------------------------------------------------- */
 /* ----------------------------this is a test for creating a new feedback object---------------------------- */
 /*
 
        Feedback o = new Feedback("JAVA", 2, date, 1);
        ServiceFeedback cv = new ServiceFeedback();

        try {
            cv.ajouterFeedback(o);
            System.out.println("ajouté avec succes");
        } catch (SQLException ex) 
        {
            System.out.println(ex);        
