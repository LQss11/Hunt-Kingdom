...
public class ServiceEvenement {
    ...
    public ArrayList<Evenement> getAllEvenementstri() {
        String url = "http://localhost/Integration/Huntkingdom/web/app_dev.php/evenement/jsoneventalltri";
        req.setUrl(url);
        req.setPost(false);
    ...
    public ArrayList<Evenement> getAllEvenements() {
        String url = "http://localhost/Integration/Huntkingdom/web/app_dev.php/evenement/jsoneventall";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
