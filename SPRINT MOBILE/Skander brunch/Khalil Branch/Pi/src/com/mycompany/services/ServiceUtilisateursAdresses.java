...
public class ServiceUtilisateursAdresses {
    ...
    public List<UtilisateursAdresses> getAdresses(Utilisateurs user) {
    ...
    public void addAdresses(String nom, String prenom, String telephone, String adresse, String cp, String pays, String ville, String complement, Utilisateurs user) {
        ConnectionRequest con = new ConnectionRequest();
