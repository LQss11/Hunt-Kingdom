...
public class ServiceFeedback {
    ...
    public boolean addFeedback(Feedback f) {
        ...
        String url = Statics.BASE_URL + "/reclamation/feedback/add/" + f.getDescription() + "/" + f.getRate() + "/10"; //création de l'URL
    ...
    public boolean updateFeedback(Feedback f) {
        //String url = Statics.BASE_URL + "/tasks/" + t.getName() + "/" + t.getStatus(); //création de l'URL
        String url = Statics.BASE_URL + "/reclamation/feedback/mod/" + f.getId() + "/" + f.getDescription(); //création de l'URL
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
    ...
    public boolean RemoveFeedback(Feedback f) {
        String url = Statics.BASE_URL + "/reclamation/feedback/rem/" + f.getId(); //création de l'URL
        req.setUrl(url);
    ...
    public ArrayList<Feedback> FindFeedback() {
        String url = Statics.BASE_URL + "/reclamation/feedback/find/70";
        req.setUrl(url);
        req.setPost(false);
        req.setHttpMethod("GET");
