...
public class User {
    ...
    public User(int enabled, String firstname, String lastname, String email, String password, String phone, String image, String role, String username, String username_canonical, String email_canonical, String date, String last_login) {
        this.enabled = enabled;
        this.firstname = firstname;
        this.lastname = lastname;
        this.email = email;
