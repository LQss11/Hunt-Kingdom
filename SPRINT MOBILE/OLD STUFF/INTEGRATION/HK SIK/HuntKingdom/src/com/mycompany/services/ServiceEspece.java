...
public class ServiceEspece {
    ...
    public static ServiceEspece getInstance() {
        ...
        public boolean addEspece(Espece t) {
        //String url = Statics.BASE_URL + "/tasks/" + t.getName() + "/" + t.getStatus(); //création de l'URL
        String url = Statics.BASE_URL + "/espece/espece/add/" + t.getNomEspece()+ "/" + t.getDescriptionEspece()+ t.getImage()+ "/" + t.getPoids()+ "/" + t.getType()+ "/" + t.getZone()+ "/" + t.getVille()+ "/"+ t.getIdS();
    ...
    public ArrayList<Espece> getAllEspeces() {
        ...
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                Especes = parseEspeces(new String(req.getResponseData()));
    ...
    public ArrayList<Espece> getEspece(String e) {
        String url = Statics.BASE_URL + "/espece/espece/find"+ e;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
