...
public class ServiceProduit {
    ...
    public ArrayList<Produit> getListProduit() {
        ...
        con.setUrl(Statics.BASE_URL + "/produit/produit/displayMobile");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    System.out.println("produit parsson 39");
                }
    ...
    public ArrayList<Produit> ProduitParseJson(String json) throws ParseException {
        ...
        try {
            ...
            System.out.println("com.mycompany.services.ServiceProduit.ProduitParseJson()");
        }
        return listProduit;
    ...
    public ArrayList<Produit> getSearchListProduit(String q) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Statics.BASE_URL + "/produit/produit/findMobile?search=" + q);
    ...
    public ArrayList<Promotion> getListPromotion() {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Statics.BASE_URL + "/produit/promotion/displayMobile");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceProduit sl = new ServiceProduit();
                try {
                    ...
                    System.out.println("promotion parsson 39");
                }
            }
        });
        NetworkManager.getInstance().addToQueueAndWait(con);
    ...
    public ArrayList<Promotion> PromotionParseJson(String json) throws ParseException {
        ...
        try {
            ...
            System.out.println("com.mycompany.services.ServiceProduit.PromotionParseJson()");
        }
        return listP;
    ...
    public ArrayList<Whishlist> getListWishlist() {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(Statics.BASE_URL + "/produit/whish/displayMobile");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceProduit sl = new ServiceProduit();
                try {
                    ...
                    System.out.println("wish parsson 39");
                }
            }
        });
        NetworkManager.getInstance().addToQueueAndWait(con);
    ...
    public void ajoutWishlist(Whishlist w) {
        ConnectionRequest con = new ConnectionRequest();
        String URL = Statics.BASE_URL + "/produit/whish/newMobile?idp=" + w.getProduit().getId() + "&idc=" + SignInForm.US.getId();
    ...
    public void deleteWishlist(int idw) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = Statics.BASE_URL + "/produit/whish/deleteMobile?" + "idw=" + idw;// création de l'URL
        System.out.println("/////////////removing/////////////////////////");
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
        con.addResponseListener((e) -> {
            String str = new String(con.getResponseData());//Récupération de la réponse du serveur
