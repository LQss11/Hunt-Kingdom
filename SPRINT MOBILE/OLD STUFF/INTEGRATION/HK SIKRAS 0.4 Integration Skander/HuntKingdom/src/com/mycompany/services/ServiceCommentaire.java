...
public class ServiceCommentaire {
    ...
    public boolean addCommentaire(String contenue, String idPub) {
        ...
        String url = Statics.BASE_URL + "/forum/commentaire/new/" + contenue +  "/" + idPub + "/2";
    ...
    public ArrayList<commentaire> FindCommentaire(String CommentaireId) {
        String url = Statics.BASE_URL + "/forum/commentaire/Coment/" + CommentaireId;
