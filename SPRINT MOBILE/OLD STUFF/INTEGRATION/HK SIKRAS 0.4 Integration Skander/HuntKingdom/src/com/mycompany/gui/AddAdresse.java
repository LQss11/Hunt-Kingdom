...
public class AddAdresse {
    ...
    public AddAdresse() {
        ...
        btn.addActionListener((evt) -> {
            ...
            sr.addAdresses(txnom.getText(), txprenom.getText(), txtel.getText(), txln1.getText(), txzip.getText(), txst.getText(), txci.getText(), txln2.getText(), SignInForm.US);
