...
public class Panier {
    ...
    public Panier(Resources theme) {
        ...
        for (Produit p : ls) {
            ...
            URLImage imgUrl
                    = URLImage.createToStorage(encImg, Statics.BASE_URL +"/HuntKingdomvFINALLLLLLLLL/web/images/" + p.getImage(), Statics.BASE_URL +"/HuntKingdomvFINALLLLLLLLL/web/images/" + p.getImage(), URLImage.RESIZE_SCALE);
          ...
          c1.add(lb);
            c.add(c1);
            Button btn = new Button(theme.getImage("rm.png"));
            btn.setUIID("label");
