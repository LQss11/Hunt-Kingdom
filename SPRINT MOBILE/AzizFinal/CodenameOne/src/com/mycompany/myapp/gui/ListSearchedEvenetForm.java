...
public class ListSearchedEvenetForm extends Form
{
    ...
    ListSearchedEvenetForm(Evenement f,Form previousevents) 
    {
                    ...
                    if (new ListEvenementForm(null).Exist(f.getId(),1) != null)
            {
            ...
            else
            {
                    ...
                    btninscrit.addActionListener(new ActionListener() 
                    {
                         ...
                         public void actionPerformed(ActionEvent evt) 
                         {
                            ...
                            new ListSearchedEvenetForm(f,null).show();
                            
                         }
                    });
            }
       getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> previousevents.showBack()); 
    }
}
