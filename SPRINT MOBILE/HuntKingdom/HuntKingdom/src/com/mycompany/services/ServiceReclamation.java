...
public class ServiceReclamation {
    ...
    public boolean addReclamation(Reclamation r) {
        ...
        String url = Statics.BASE_URL + "/reclamation/reclamation/add/" + r.getType() + "/" + r.getSujet() + "/" + r.getDescription() + "/" + UserSessionId+"/"+r.getIdo();
        req.setUrl(url);
        req.setPost(true);
    ...
    public boolean updateReclamation(Reclamation r) {
        String url = Statics.BASE_URL + "/reclamation/reclamation/mod/" + r.getId() + "/" + r.getDescription()+ "/" + r.getEtat();
        req.setUrl(url);
        req.setPost(true);
    ...
    public ArrayList<Reclamation> parseReclamations(String jsonText) {
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                r.setUsername(User.get("username").toString());
                Reclamations.add(r);
            }
